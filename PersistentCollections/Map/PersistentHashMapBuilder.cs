...
public class PersistentHashMapBuilder<TKey, TValue> : IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>
{
  private IndexNode<TKey, TValue> myRoot;
  private readonly PersistentHashMap<TKey, TValue>.Comparers myComparers;
  ...
  internal PersistentHashMapBuilder(IndexNode<TKey, TValue> root, int count, PersistentHashMap<TKey, TValue>.Comparers comparers)
  {
    myRoot = root;
    Count = count;
  ...
  public PersistentHashMap<TKey, TValue> Build()
  {
    var root = myRoot;
    return new PersistentHashMap<TKey, TValue>(root, Count, myComparers);
  }
